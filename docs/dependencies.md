...
| --- | --- | --- | --- |
| [**Pithos**](https://github.com/pithos/pithos) | `pithos` | Yes | Pandora has no public hobby OAuth like Spotify. Pithos logs in, holds the station list, and plays audio. OmaPandora talks to it over MPRIS. |
| [**cava**](https://github.com/karlstav/cava) | `cava` | Yes (for the visualizer) | Now Playing bar visualizer. Listens to the default speaker monitor, not the microphone. |
